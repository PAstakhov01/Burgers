...
var header = document.getElementsByClassName('section-top');
var heading = document.getElementsByClassName('banner');
var labels = document.getElementsByClassName('menu__item');
